...
#include <Windows.h>
const short TOP_BOUND = 1, BOTTOM_BOUND = 23, ROW_ONE = 28, ROW_TWO = 66;
...
void ChessBoard::printThePlane()
{
    ...
    cout << "╙";
    SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), { static_cast<short>(ROW_TWO - 3),static_cast<short>(BOTTOM_BOUND - 1) });
    cout << "╜";
